...
function loadExternalContent(containerId, url) {
    fetch(url)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    loadExternalContent('header-container', 'includes/src/header.html');
    loadExternalContent('footer-container', 'includes/src/footer.html');
